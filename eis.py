...
# VARIABLE IMPORT
from overview import df_eis

#CONDITIONING-------------------------------------------------------------------------------------------

time = df_eis['Time Stamp']
voltage = df_eis['voltage']
current = df_eis['current']

temp_cell_an = df_eis['temp_anode_endplate']
temp_cell_cat = df_eis['temp_cathode_endplate']

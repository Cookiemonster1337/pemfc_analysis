...
# VARIABLE IMPORT
from overview import df_cond


#CONDITIONING-------------------------------------------------------------------------------------------

time = df_cond['Time Stamp']
voltage = df_cond['voltage']
current = df_cond['current']

temp_cell_an = df_cond['temp_anode_endplate']
temp_cell_cat = df_cond['temp_cathode_endplate']
